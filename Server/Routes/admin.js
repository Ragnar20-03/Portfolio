...
router.post('/addProject' ,adminMiddleware, async(req ,res)=>{
    ...
    if(parsing.success == true){
        ProjectModel.create({
            ...
            let query = await AdminModel.updateOne({username : adminUsername} , {$push : {
...
router.get('/getProjects',adminMiddleware , async(req ,res ) =>{    
...
router.get('/getProjects/:id',adminMiddleware, async(req ,res ) =>{
