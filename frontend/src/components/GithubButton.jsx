...
const GithubButton = ({ children, repoLink }) => {
  return (
    <a
      ...
      className="inline-flex items-center min-h-[40px] cursor-pointer bg-slate-700 hover:bg-slate-800 text-white border-slate-800  text-sm py-2 pr-3 rounded-md dark:text-black dark:border-black border-[1px] dark:bg-white dark:hover:bg-gray-200 dark:hover:text-black group"
    >
      <svg
        height="20"
        viewBox="0 0 16 16"
